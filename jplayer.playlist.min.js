...
(function(b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createItemHandlers: function() {
            ...
            b(this.cssSelector.playlist).off("click", "a." + this.options.playlistOptions.removeItemClass).on("click", "a." + this.options.playlistOptions.removeItemClass, function(c) {
                c.preventDefault();
                c = b(this).parent().parent().index();
                a.remove(c);
                a.blur(this)
        ...
        _updateControls: function() {
            ...
            b(this.cssSelector.shuffle).length && b(this.cssSelector.shuffleOff).length && (this.shuffled ? (b(this.cssSelector.shuffleOff).show(),
        ...
        select: function(a) {
            ...
            0 <= a && a < this.playlist.length ? (this.current = a,
            this._highlight(a),
